// Hace llamado a la tabla y aplica paginacion -->
  ...
  $(document).ready(function(){
    ...
    tabla_relax = $('#tabla-rel').DataTable({
      scrollX: true,
      autoWidth: true,
      responsive: false,
      scrollY: 450,
      ...
      "ajax": {
        url: BASE_URL + "/partials/rellrel.php",
        type: "POST",
        },
...
function cargarDatosColaborador(CURP) {
    $.ajax({
        ...
        success: function (data) {
            ...
            // Paso 2
            $('#asistencia').val(data.acudiorel);
            $('#observaciones').val(data.obs_relax);
...
$('#formWizard').on('submit', function (e) {
    ...
    $.ajax({
        url: BASE_URL + '/save/update_relax.php',
        type: 'POST',
        data: $(this).serialize(),
        dataType: 'json',
        ...
        success: function (resp) {
            ...
            if (resp.success) {
                ...
                if ($.fn.DataTable.isDataTable('#tabla-rel')) {
                    $('#tabla-rel').DataTable().ajax.reload(null, false);
                }
...
function procesarEscaneo(CODIGO){
    ...
    $.ajax({
        url: BASE_URL + '/save/update_asistencia_REL.php',
        method: 'POST',
        data: { codigo: CODIGO },
        dataType: 'json', 
        success: function(response){
            ...
            if(response.success){
                ...
                tabla_relax.ajax.reload(null, false);
