// Hace llamado a la tabla y aplica paginacion -->
  ...
  $(document).ready(function(){
    ...
    tabla_corporal = $('#tabla-cco').DataTable({
      scrollX: true,
      autoWidth: true,
      responsive: false,
      scrollY: 450,
...
function cargarDatosColaborador(CURP) {
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#marcapasos').val(data.marcapasos);
            $('#observaciones').val(data.obs_corpo);
    ...
    $.ajax({
        ...
        success: function (resp) {
            ...
            if (resp.success) {
                ...
                if ($.fn.DataTable.isDataTable('#tabla-cco')) {
                    $('#tabla-cco').DataTable().ajax.reload(null, false);
                }
