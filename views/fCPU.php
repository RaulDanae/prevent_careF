...
<html lang="es">
    ...
    <link rel="stylesheet" type = "text/css" href="<?= BASE_URL ?>/assets/css/maincpu.css">
    ...
    <title>Capacidad Pulmonar</title>
    ...
    <body>
        ...
        <div class="container-fluid px-4 my-4">
            <div class="card shadow-sm w-100">
                <div class="card-body">
                    ...
                    <?php include '../partials/tpulm.php'; ?>
        ...
        <script src= '<?= BASE_URL ?>/assets/js/pulm.js'></script>
