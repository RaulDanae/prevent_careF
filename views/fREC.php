...
<script>
    ...
    // Esta linea pasa la variable de php a javascript para que pueda dar o quitar permisos a perfil en selec2
    const puedeCrearCatalogos = <?= $puedeCrearCatalogos ? 'true' : 'false' ?>;
