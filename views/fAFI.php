...
<html lang="es">
    ...
    <link rel="stylesheet" type = "text/css" href="<?= BASE_URL ?>/assets/css/mainafi.css">
    ...
    <body>
        ...
        <script src= '<?= BASE_URL ?>/assets/js/fis.js'></script>
