...
<html lang="es">
    ...
    <link rel="stylesheet" type = "text/css" href="<?= BASE_URL ?>/assets/css/maintsv.css">
    ...
    <body>
        ...
        <div class="container-fluid px-4 my-4">
            <div class="card shadow-sm w-100">
                <div class="card-body">
                    ...
                    <?php include '../partials/tvit.php'; ?>

                </div>
            </div>
        </div>

        <?php include '../partials/nuevo_vit.php'; ?>
        ...
        <script src= '<?= BASE_URL ?>/assets/js/vit.js'></script>
...
<script>
    const INFO_MODULO = `
        <p><strong>Toma de Signos Vitales</strong></p>
        <p>Se registran los signos Vitales del Colaborador.</p>
        <p>Presion Sistolica, Presion Diastolica, Frecuencia Cardiaca y Oxigenacion.</p>
