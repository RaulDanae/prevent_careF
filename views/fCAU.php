...
<html lang="es">
    ...
    <link rel="stylesheet" type = "text/css" href="<?= BASE_URL ?>/assets/css/maincau.css">
    ...
    <body>
        ...
        <script src= '<?= BASE_URL ?>/assets/js/aud.js'></script>
