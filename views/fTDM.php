...
<html lang="es">
    ...
    <link rel="stylesheet" type = "text/css" href="<?= BASE_URL ?>/assets/css/maintdm.css">
    ...
    <body>
        ...
        <script src= '<?= BASE_URL ?>/assets/js/mue.js'></script>
