<?php
    ...
    $conn = conn();
    $query = "SELECT t1.id_comp, t1.nomcom FROM compania t1 ORDER BY t1.id_comp ASC";
...
<html lang="es">
    ...
    <script type = "text/javascript" src = "<?= BASE_URL ?>/assets/libs/js/select2.min.js"></script>
    <!-- /JS -->
    ...
    <body>
        ...
        <div class="container-fluid px-4 my-4">
            <div class="card shadow-sm w-100">
                <div class="card-body">
                    ...
                    <?php include '../partials/teve.php'; ?>

                </div>
            </div>
        </div>

        <?php include '../partials/nuevo_eve.php'; ?>
        ...
        <script src= '<?= BASE_URL ?>/assets/js/eve.js'></script>
...
<script>
    const INFO_MODULO = `
        ...
        <p>Aqui se dan de alta las compañias asociadas a los pacientes.</p>
        <p>Nombre, Nombre corto.</p>
