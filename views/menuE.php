...
<head>
  ...
  <!-- CSS -->
   ...
   <link rel="stylesheet" type = "text/css" href="<?= BASE_URL ?>/assets/css/menuE.css">
  <!-- /CSS -->
  <!-- JS -->
...
<body>
    ...
    <?php include '../partials/navbarE.php'; ?>
...
<script>
    const INFO_MODULO = `
        ...
        <p>Aqui se registran los estudios para los pacientes:</p>
        <p>Recepcion.</p>
        <p>Estudios.</p>
    `;
</script>
