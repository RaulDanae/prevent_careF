...
<html lang="es">
    ...
    <link rel="stylesheet" type = "text/css" href="<?= BASE_URL ?>/assets/css/mainsnu.css">
    ...
    <body>
        ...
        <div class="container-fluid px-4 my-4">
            <div class="card shadow-sm w-100">
                <div class="card-body">
                    ...
                    <?php include '../partials/tnutr.php'; ?>
        ...
        <script src= '<?= BASE_URL ?>/assets/js/nutr.js'></script>
