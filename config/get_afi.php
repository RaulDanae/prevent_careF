<?php
    ...
    $stmt = $conn->prepare(
        "SELECT t2.id_paciente_evento, t1.colaborador, t1.genero, t1.fec_nac, t3.acudiofis, t3.obs_fis
         FROM pacientes t1
         LEFT JOIN paciente_evento t2 ON t1.id = t2.id_paciente
         LEFT JOIN tfisica t3 ON t2.id_paciente_evento = t3.id_paciente_evento
