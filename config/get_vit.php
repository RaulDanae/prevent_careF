<?php
    ...
    $stmt = $conn->prepare(
        "SELECT t2.id_paciente_evento, t1.colaborador, t1.genero, t1.fec_nac, t3.psistolica, t3.pdiastolica, t3.fcardiaca, t3.oxigenacion,
                t3.obs_vital
         FROM pacientes t1
         LEFT JOIN paciente_evento t2 ON t1.id = t2.id_paciente
         LEFT JOIN tvitales t3 ON t2.id_paciente_evento = t3.id_paciente_evento
