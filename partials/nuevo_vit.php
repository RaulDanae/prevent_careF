            ...
            <!-- Stepper -->
             <div class="stepper-container mb-3">
                ...
                <div class="stepper d-flex justify-content-between">
                    ...
                    <div class="step-item" data-step="2">Signos</div>
                ...
                <div class="modal-body">
                    ...
                    <!-- Paso 2 -->
                     <div class="step" data-step="2">
                        <div class="row mb-2">
                            <div class="col-md-4">
                                <label for="sistolica" class="etiquetaL">Presion Sistolica</label>
                                <input type="number" class="form-control" name="sistolica" id="sistolica" required>
                            </div>
                            <div class="col-md-4">
                                <label for="diastolica" class="etiquetaL">Presion Diastolica</label>
                                <input type="number" class="form-control" name="diastolica" id="diastolica" required>
                            </div>
                            <div class="col-md-4">
                                <label for="cardiaca" class="etiquetaL">Frecuencia Cardiaca</label>
                                <input type="number" class="form-control" name="cardiaca" id="cardiaca" required>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-4">
                                <label for="oxigenacion" class="etiquetaL">Oxigenacion</label>
                                <input type="number" class="form-control" name="oxigenacion" id="oxigenacion" required>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-12">
